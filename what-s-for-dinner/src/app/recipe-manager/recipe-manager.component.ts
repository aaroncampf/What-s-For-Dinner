...
export class RecipeManagerComponent implements OnInit {
  ...
  /*
    ...
    async initialLoad(): Promise<any>{
      ...
      localStorage.setItem("recipeDB", recipeDB);
    }
    ...
    async deleteExistingRecipe(): Promise<any>{
      ...
      localStorage.setItem("recipesToKeep", JSON.stringify(recipesToKeep));
    }
    ...
    async addRecipe(): Promise<any>{
      ...
      localStorage.setItem('recipeToAdd', JSON.stringify(recipeToAdd));
    }
  
    async getRecipes(): Promise<Recipe[]>{
      
      let recipeModel : recipeModel = JSON.parse(JSON.stringify(recipeDB.Item));
